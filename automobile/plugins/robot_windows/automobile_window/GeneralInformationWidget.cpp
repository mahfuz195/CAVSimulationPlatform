...
void GeneralInformationWidget::init() {
  ...
  if(wbu_car_get_engine_type() == WBU_CAR_COMBUTSION_ENGINE)
...
void GeneralInformationWidget::updateInformation() {
  ...
  for (int i=0; i<WBU_CAR_WHEEL_NB; ++i) {
    mWheelSpeeds[i] = wbu_car_get_wheel_speed(i);
    mWheelEncoders[i] = wbu_car_get_wheel_encoder(i);
  }
  this->repaint();
...
void GeneralInformationWidget::drawAxes(QPainter &painter) {
  ...
  painter.setPen(pen);
  painter.drawLine(mFrontAxisCenterPosition[0], mFrontAxisCenterPosition[1], mRearAxisCenterPosition[0], mRearAxisCenterPosition[1]);
  painter.drawLine(mFrontAxisRightPosition[0], mFrontAxisRightPosition[1], mFrontAxisLeftPosition[0], mFrontAxisLeftPosition[1]);
  ...
  painter.setPen(pen);
  painter.drawText(mFrontAxisCenterPosition[0] + 5, mFrontAxisCenterPosition[1] + 12, QString::number(mFrontTrack) + QString(" m"));
  painter.drawText(mRearAxisCenterPosition[0] - 25, mRearAxisCenterPosition[1] + 15, QString::number(mRearTrack) + QString(" m"));
...
void GeneralInformationWidget::drawDirectionArray(QPainter &painter) {
  ...
  painter.drawText(mFrontAxisCenterPosition[0] - 95, mFrontAxisCenterPosition[1] - 8, QString("Steering angle:    ") + QString::number(mSteeringAngle));
}
...
void GeneralInformationWidget::drawGearboxStateOrTargetSpeed(QPainter &painter) {
  ...
  if (mIsTorqueControl) {
    ...
    painter.drawText(mCenterPosition[0] - 250, mCenterPosition[1] + 7.5, QString("Engaged gear: ") + QString::number(mGearbox) + QString(" / ") + QString::number(mGearNumber));
  } else
    painter.drawText(mCenterPosition[0] - 250, mCenterPosition[1], QString("Target Speed: ") + QString::number(mTargetSpeed, 'g', 3) + QString(" km/h"));
}
...
void GeneralInformationWidget::drawTypes(QPainter &painter) {
  ...
  painter.drawText((mCenterPosition[0] + mFrontAxisRightPosition[0]) / 2 , mCenterPosition[1] - 7.5, QString("Engine type: ") + mEngineType);
  painter.drawText((mCenterPosition[0] + mFrontAxisRightPosition[0]) / 2 , mCenterPosition[1] + 7.5, QString("Transmission type: ") + mTransmissionType);
}
...
void GeneralInformationWidget::drawWheels(QPainter &painter) {
  ...
  painter.translate(-mFrontAxisLeftPosition[0], -mFrontAxisLeftPosition[1]);
  // rear right
  painter.drawRect(mRearAxisRightPosition[0] - WHEEL_WIDTH / 2, mRearAxisRightPosition[1] - WHEEL_HEIGHT / 2, WHEEL_WIDTH, WHEEL_HEIGHT);
  // rear left
  painter.drawRect(mRearAxisLeftPosition[0] - WHEEL_WIDTH / 2, mRearAxisLeftPosition[1] - WHEEL_HEIGHT / 2, WHEEL_WIDTH, WHEEL_HEIGHT);

  // display wheels radius
  painter.setFont(QFont("Arial", 10));
  pen.setBrush(Qt::darkGreen);
  painter.setPen(pen);
  painter.drawText(mRearAxisRightPosition[0] - 25, mRearAxisRightPosition[1] - WHEEL_HEIGHT / 2 - 5, QString("Radius: ") + QString::number(mRearWheelRadius) + QString(" m"));
  painter.drawText(mRearAxisLeftPosition[0] - 25, mRearAxisRightPosition[1] - WHEEL_HEIGHT / 2 - 5, QString("Radius: ") + QString::number(mRearWheelRadius) + QString(" m"));
  painter.drawText(mFrontAxisRightPosition[0] - 25, mFrontAxisRightPosition[1] + WHEEL_HEIGHT / 2 + 15, QString("Radius: ") + QString::number(mFrontWheelRadius) + QString(" m"));
  painter.drawText(mFrontAxisLeftPosition[0] - 25, mFrontAxisRightPosition[1] + WHEEL_HEIGHT / 2 + 15, QString("Radius: ") + QString::number(mFrontWheelRadius) + QString(" m"));
}
...
void GeneralInformationWidget::drawWheelsInformation(QPainter &painter) {
  ...
  // front right
  painter.drawText(mFrontAxisRightPosition[0] + 30, mFrontAxisRightPosition[1] - 15, QString("Speed: ") + QString::number(mWheelSpeeds[WBU_CAR_WHEEL_FRONT_RIGHT], 'g', 3) + QString(" rad/s"));
  painter.drawText(mFrontAxisRightPosition[0] + 30, mFrontAxisRightPosition[1], QString("Encoder: ") + QString::number(mWheelEncoders[WBU_CAR_WHEEL_FRONT_RIGHT], 'g', 3) + QString(" rad"));
  painter.drawText(mFrontAxisRightPosition[0] + 30, mFrontAxisRightPosition[1] + 15, QString("Angle: ") + QString::number(mRightSteeringAngle, 'g', 5) + QString(" rad"));
  // rear right
  painter.drawText(mRearAxisRightPosition[0] + 30, mRearAxisRightPosition[1] - 7.5, QString("Speed: ") + QString::number(mWheelSpeeds[WBU_CAR_WHEEL_REAR_RIGHT], 'g', 3) + QString(" rad/s"));
  painter.drawText(mRearAxisRightPosition[0] + 30, mRearAxisRightPosition[1] + 7.5, QString("Encoder: ") + QString::number(mWheelEncoders[WBU_CAR_WHEEL_REAR_RIGHT], 'g', 3) + QString(" rad"));
  // front left
  painter.drawText(mFrontAxisLeftPosition[0] - 150, mFrontAxisLeftPosition[1] - 15, QString("Speed: ") + QString::number(mWheelSpeeds[WBU_CAR_WHEEL_FRONT_LEFT], 'g', 3) + QString(" rad/s"));
  painter.drawText(mFrontAxisLeftPosition[0] - 150, mFrontAxisLeftPosition[1], QString("Encoder: ") + QString::number(mWheelEncoders[WBU_CAR_WHEEL_FRONT_LEFT], 'g', 3) + QString(" rad"));
  painter.drawText(mFrontAxisLeftPosition[0] - 150, mFrontAxisLeftPosition[1] + 15, QString("Angle: ") + QString::number(mLeftSteeringAngle, 'g', 5) + QString(" rad"));
  // rear left
  painter.drawText(mRearAxisLeftPosition[0] - 150, mRearAxisLeftPosition[1] - 7.5, QString("Speed: ") + QString::number(mWheelSpeeds[WBU_CAR_WHEEL_REAR_LEFT], 'g', 3) + QString(" rad/s"));
  painter.drawText(mRearAxisLeftPosition[0] - 150, mRearAxisLeftPosition[1] + 7.5, QString("Encoder: ") + QString::number(mWheelEncoders[WBU_CAR_WHEEL_REAR_LEFT], 'g', 3) + QString(" rad"));
}
