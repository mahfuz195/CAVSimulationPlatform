...
void OSMImportWidget::launchExecutable() {
  QString gui_executable = qgetenv("WEBOTS_HOME") + QString("/projects/automobile/resources/OSM_importer/osm_gui/osm_gui"); // TODO, need to handle Windows
  const QStringList arguments = QStringList(qgetenv("WEBOTS_HOME") + QString("/projects/automobile/resources/OSM_importer/importer.py"));
